  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-bg-base transition-colors duration-200">
      <div className="w-full max-w-sm p-8 bg-bg-surface border border-border-subtle rounded-2xl shadow-glass">
        ...
        <div className="text-center mt-6 text-xs text-text-muted border-t border-border-subtle pt-4 select-none">
          <p>Demo account: <span className="font-mono text-text-secondary bg-bg-elevated px-1 py-0.5 rounded">admin@wayline.com</span></p>
          <p className="mt-1">Password: <span className="font-mono text-text-secondary bg-bg-elevated px-1 py-0.5 rounded">password</span></p>
        </div>
      </div>
    </div>
  );
